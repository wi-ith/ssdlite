...
class ssd_random_crop:
    ...
    def bboxes_resize(self,boxes, window, scope=None):
    ...
    def bboxes_intersection(self,bbox_ref, bboxes, name=None):
    ...
    def random_crop_image(self,
        ...
        boxes = self.bboxes_resize(boxes, im_box_rank1)
